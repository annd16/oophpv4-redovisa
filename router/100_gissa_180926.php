...
$app->router->any(["get", "post"], "gissa/session-object", function () use ($app) {
    ...
    if (isset($_POST["cheat"])) {
        ...
        try {
            ...
            echo "(\$_POST['guessedNumber'] === \Anna\Session\Session::get('guess')->getTheNumber()) = " . ($_POST['guessedNumber'] === \Anna\Session\Session::get('guess')->getTheNumber());
            ...
            $extraMessage = $comparison;
            $result = \Anna\Result\Result::getResult($resCode, htmlentities($_POST['guessedNumber']), \Anna\Session\Session::get('guess')->getTheNumber(), \Anna\Session\Session::get('guess')->getNoGuessesLeft(), $extraMessage);
        } catch (\Exception $e) {
            $noGuessesLeft = \Anna\Session\Session::get('guess')->getNoGuessesLeft();
            $noGuessesLeft += 1;
